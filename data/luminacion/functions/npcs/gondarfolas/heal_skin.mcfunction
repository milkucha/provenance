# =============================================================================
# Luminacion — Gondarfolas Skin Self-Heal
# =============================================================================
...
execute as @e[type=taterzens:npc,name=Gondarfolas,limit=1] at @s unless data entity @s TaterzenNPCTag.skin.value run npc edit skin https://minesk.in/8e4356a7612f4b97ac864836457b274e
