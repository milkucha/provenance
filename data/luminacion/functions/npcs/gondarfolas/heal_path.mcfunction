...
# on a false positive.
#
# No path has been defined for Gondarfolas yet, so this file has nothing to
# do. Once functions/npcs/gondarfolas/paths/<path_name>.mcfunction exists,
# add a line here for it — one line per path defined for this NPC:
#
#   execute if data storage luminacion:npcs {gondarfolas:{active_path:"<path_name>"}} unless data entity @e[type=taterzens:npc,name=Gondarfolas,limit=1] TaterzenNPCTag.PathTargets[0] run function luminacion:npcs/gondarfolas/paths/<path_name>
# =============================================================================
