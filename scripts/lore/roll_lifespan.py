...
scripts/lore/horizon.py, which answers with a coarse band and never the number.
...
mechanically, once it has already closed. See _lore/facts/life_is_finite.md and scripts/lore/horizon.py.
...
Usage:
    python scripts/lore/roll_lifespan.py                      # 30-60 scenes, the world's normal range
    python scripts/lore/roll_lifespan.py --min 2 --max 4      # short lives, for testing the endgame
...
def main() -> None:
    ...
    print("See _lore/facts/life_is_finite.md and scripts/lore/horizon.py.")
